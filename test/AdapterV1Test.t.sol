...
contract AdapterV1Test is Test {
    ...
    //     vm.startPrank(alice);
    //     principalToken.approve(adapterAddress, 1e18);
    ...
    //     vm.startPrank(alice);
    //     principalToken.approve(adapterAddress, 1e5);
    //     uint256 balanceBeforeAlice = principalToken.balanceOf(alice);
    //     adapter.stake(1e5);
    //     (
    ...
    //     ) = adapter.getUpdateAccount(alice, 0, true);

    //     assertEq(lastUpdateTime, block.timestamp);
    //     assertEq(lastMaxLockDuration, maxLockDuration);
    //     assertEq(stakedBalance, 1e5);
    //     assertEq(maxStakeDebt, (1e5 * maxLockDuration * WAD) / denominator);
    //     assertEq(portalEnergy, (1e5 * maxLockDuration * WAD) / denominator);
    ...
    //         availableToWithdraw,
    //         tokensToBurn
    //     ) = portal.getUpdateAccount(adapterAddress, 0, true);
    //     assertEq(lastUpdateTime, block.timestamp);
    //     assertEq(lastMaxLockDuration, maxLockDuration);
    //     assertEq(stakedBalance, 1e5);
    //     assertEq(maxStakeDebt, (1e5 * maxLockDuration * WAD) / denominator);
    ...
    //     // check alice balance
    //     uint256 balanceAfterAlice = principalToken.balanceOf(alice);
    ...
    //     uint256 maxLockDuration = getmaxLockDuration();
    //     vm.startPrank(alice);
    //     principalToken.approve(adapterAddress, 2e5);
    //     uint256 balanceBeforeAlice = principalToken.balanceOf(alice);
    //     adapter.stake(1e5);
    //     adapter.stake(1e5);
    //     (
    ...
    //     vm.warp(block.timestamp + 60);
    //     portalEnergyToken.approve(adapterAddress, 246575342465753424);
    //     vm.expectEmit(adapterAddress);
    ...
    //     vm.startPrank(alice);
    //     adapter.mintPortalEnergyToken(bob, 246575342465753424);
    //     assertEq(portalEnergyToken.balanceOf(bob), 246575342465753424);
    ...
    //     portalEnergyToken.approve(adapterAddress, 246575342465753424);
    //     adapter.burnPortalEnergyToken(alice, 246575342465753424);
    //     assertEq(portalEnergyToken.balanceOf(bob), 0);
    //     (, , , , , uint256 portalEnergy, ) = adapter.getUpdateAccount(alice, 0);
    ...
    //     help_stake();
    //     vm.startPrank(alice);
    //     PSM.approve(adapterAddress, 2e10);
    ...
    //     help_stake();
    //     uint256 expect = portal.quoteBuyPortalEnergy(1e15);
    //     vm.startPrank(alice);
    //     PSM.approve(adapterAddress, 1e15);
    //     vm.expectEmit(adapterAddress);
    ...
    //     help_stake();
    //     uint256 expect = portal.quoteSellPortalEnergy(1e15);
    //     vm.startPrank(alice);
    //     vm.expectEmit(adapterAddress);
    ...
    //     help_stake();
    //     uint256 expect = portal.quoteBuyPortalEnergy(2e18);
    //     (
    //         ,
    //         ,
    //         ,
    ...
    //     uint256 balancePSMAliceBefore = PSM.balanceOf(alice);
    //     uint256 balancePSMPortalBefore = PSM.balanceOf(address(portal));
    //     vm.startPrank(alice);
    //     PSM.approve(adapterAddress, 2e18);
    ...
    //         availableToWithdraw
    //     ) = adapter.accounts(alice);
    //     uint256 balancePSMAliceAfter = PSM.balanceOf(alice);
    //     uint256 balancePSMPortalAfter = PSM.balanceOf(address(portal));

    //     assertEq(stakedBalance, 1e18);
    //     assertEq(maxStakeDebt, (1e18 * maxLockDuration * WAD) / denominator);
    ...
    //     help_stake();
    //     uint256 expect = portal.quoteSellPortalEnergy(1e10);
    //     (
    //         ,
    //         ,
    //         ,
    ...
    //     ) = adapter.accounts(alice);
    //     uint256 portalEnergyBefore = portalEnergy;
    //     uint256 balancePSMBobBefore = PSM.balanceOf(bob);
    //     uint256 balancePSMPortalBefore = PSM.balanceOf(address(portal));
    //     vm.startPrank(alice);
    ...
    //         .accounts(alice);
    //     uint256 balancePSMBobAfter = PSM.balanceOf(bob);
    //     uint256 balancePSMPortalAfter = PSM.balanceOf(address(portal));
    ...
    //     vm.startPrank(alice);
    //     principalToken.approve(adapterAddress, 5e20);
    //     adapter.stake(alice, 5e20);
    //     (, , , , , uint256 portalEnergy, ) = adapter.accounts(alice);
    //     uint256 expectPSM = portal.quoteSellPortalEnergy(portalEnergy);
    ...
    //     assertEq(
    //         balancePSMPortalBefore - PSM.balanceOf(address(portal)),
    //         expectPSM
    //     );
    //     assertEq(PSM.balanceOf(adapterAddress), 0);
    ...
    // ) public {
    //     vm.startPrank(karen);
    //     PSM.approve(adapterAddress, type(uint256).max);
    ...
    //     uint256 balance0before = PSM.balanceOf(karen);
    ...
    //     assertEq(balance0before - amountA, PSM.balanceOf(karen));
    ...
    //         portal.quoteBuyPortalEnergy(1e15)
    //     );
    // }
    ...
    //         portal.quoteSellPortalEnergy(1e15)
    //     );
    // }
}
